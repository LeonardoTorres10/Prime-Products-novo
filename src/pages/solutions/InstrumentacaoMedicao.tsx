        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          ...
          <AnimateOnScroll delay={400}>
            <div className="text-xl text-gray-300 max-w-3xl mx-auto font-light">
              <EditableElement id="sol_med_sub" defaultContent="Transmissores, sensores e sistemas de medição de alta precisão para processes críticos." />
            </div>
          </AnimateOnScroll>
        </div>
      </EditableElement>
        ...
        <SectionContainer className="py-0">
          <AnimateOnScroll>
            <p className="text-primary font-bold uppercase tracking-widest text-xs mb-6 text-center">
              {t('apps_equipments', 'Aplicações e Equipamentos')}
            </p>
          </AnimateOnScroll>
